...
--    location = Vector:create(width/2, height/2)
   ...
   mover=Mover:create(location2, velocity)
   wmover = Mover:create (location1, velocity, 5)
   wmover.size = 30
...
function love.draw()
    ...
    love.graphics.setColor(255/255, 216/255, 252/255, 0.5)
    love.graphics.rectangle("fill", 0 , 0, 400, 600)
    love.graphics. setColor(r,g,b,a)

    local r,g,b,a = love.graphics.getColor()
    love.graphics.setColor(216/255, 216/255, 255/255, 0.5)
